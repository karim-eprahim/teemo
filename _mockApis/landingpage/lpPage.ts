...
const productsSlider: ProductsSliderTypes[] = [
    {
        ...
        img: img1,
        name: 'Main',
        link: 'https://materialm-nuxt-main.netlify.app/dashboards/analytics'
    },
    {
        type:true,
        img: img2,
        name: 'Dark',
        link: 'https://materialm-nuxt-dark.netlify.app/dashboards/ecommerce'
    },
    {
        type:true,
        img: img3,
        name: 'Horizontal',
        link: 'https://materialm-nuxt-horizontal.netlify.app/dashboards/crm'
    },
    {
        type:true,
        img: img4,
        name: 'Minisidebar',
        link: 'https://materialm-nuxt-minisidebar.netlify.app/dashboards/analytics'
    },
    {
        type:true,
        img: img5,
        name: 'RTL',
        link: 'https://materialm-nuxt-rtl.netlify.app/dashboards/ecommerce'
    },
    {
        type:true,
        img: img18,
        name: 'Default Sidebar',
        link: 'https://materialm-nuxt-default.netlify.app/dashboards/crm'
    },
    {
        type:false,
        img: img6,
...
/*User Review Section*/
import review1 from '/images/profile/user-2.jpg';
import review2 from '/images/profile/user-3.jpg';
import review3 from '/images/profile/user-4.jpg';
...
const userReview: UserReviewTypes[] = [
    {
        ...
        review: 'Such a beautiful, detailed, and extensive template. MaterialM admin is the perfect foundation for any project. I highly recommend this huge time saver.'
    },
    {
        img: review1,
        title: 'Jenny Wilson',
...
const listFeature: ListFeatureTypes[] = [
    {
        ...
        subtitle: 'We have included 6 pre-defined Theme Colors with MaterialM Admin.',
        bgcolor:'primary'
    },
    {
        icon: ShieldLockIcon,
    ...
    },
    {
        ...
        subtitle: 'Yes, we have 6 demos & 75+ Pages per demo to make it easier.',
        bgcolor:'info'
    },
    {
    ...
    },
    {
        ...
        subtitle: 'Lots of Icon Fonts are included here in the package of MaterialM Admin.',
        bgcolor:'success'
    },
    {
        icon: DatabaseIcon,
