import type { cardsType, followCard, musicCards, productsCards, socialiconCards, profileCard, upcommingLists, userCard,paymentGateway,RecentTransaction } from '@/types/components/widget/card';
/*import tabler icons*/
import {
    BrandFacebookIcon,
    BrandGithubIcon,
...
export { blogCard, followerCard, musicCard, productsCard, socialiconCard, profileCards, upcommingCards, userCards,paymentGateways,RecentTransactionData }