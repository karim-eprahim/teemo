            ...
            <v-row class="d-flex justify-center align-center">
                <v-col cols="12" lg="6" class="text-align-start">
                    ...
                    <div class="d-flex flex-wrap  ga-sm-6 ga-3 pt-9 pb-7 justify-md-start justify-center align-center technology">
                        <div v-for="(item, i) in technology" :key="i">
                            <div class="d-flex justify-center align-center round-56 rounded-lg bg-surface elevation-1">
                    ...
                    <div class="d-flex justify-md-start justify-center">
                        <v-btn color="primary" class="px-8 transform-none m-btn-full" size="large" flat href="/auth/login" target="_blank"
                            >Log in</v-btn
                        >
                    </div>
                </v-col>
                <v-col cols="12" lg="6">
                    <div class="main-banner d-lg-block d-none">
                        <img src="/images/front-pages/background/main-banner.webp" alt="banner-right-image" class="rtlImg" />
                    </div>
                </v-col>
            </v-row>
        </v-container>
