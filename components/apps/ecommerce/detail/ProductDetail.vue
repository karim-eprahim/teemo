            ...
            <v-col lg="6" sm="12" class="pl-lg-5 product-details">
                <div>
                    <div class="d-flex align-center gap-2">
                        <v-chip color="success" variant="elevated" size="small" elevation="0" rounded="lg" v-if="getProduct.isStock"> In Stock </v-chip>
                        <v-chip color="error" rounded="lg" v-else> Out of Stock </v-chip>
