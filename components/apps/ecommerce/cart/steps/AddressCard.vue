    ...
    <v-card variant="outlined">
        <v-card-text>
            <div class="d-flex align-center gap-2">
                ...
                <small class="text-medium-emphasis d-block">({{ destination }})</small>   
            </div>
            
                <v-chip color="primary" size="x-small" rounded="pill" class="ml-auto mt-2" v-if="isDefault">Default</v-chip>
