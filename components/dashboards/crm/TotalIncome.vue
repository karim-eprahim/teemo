...
<template>
    <v-card elevation="10" class="bg-lightsecondary">
        <v-card-item>
            ...
            <v-row class="d-flex justify-space-between align-end mt-9">
                <v-col cols="7" xl="5" class="mb-1">
                    <h2 class="text-h2 mb-3">$6,280</h2>
                    <span class="text-12 rounded-pill px-2 py-1 lh-normal text-muted light-chip font-weight-medium">+18% last month</span>
                </v-col>
                <v-col cols="5" xl="5">
                    <ClientOnly><apexchart type="area" height="70" :options="chartOptions" :series="chartOptions.series"> </apexchart></ClientOnly>
                </v-col>
            </v-row>
        </v-card-item>
    </v-card>
