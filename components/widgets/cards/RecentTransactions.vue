...
import { RecentTransactionData } from '@/_mockApis/components/widget/card';
    ...
    <v-card elevation="10">
        <v-card-item>
            ...
            <div class="daily-activities mt-10 px-3">
                <div v-for="list in RecentTransactionData" :key="list.title">
                    <v-row class="d-flex mb-1">
                        <v-col cols="4" lg="3" md="auto" sm="auto" class="px-0 pt-0 pb-0 d-flex align-start">
                            <p class="text-body-1 textSecondary text-no-wrap">{{ list.title }}</p>
                        </v-col>
