...
import QuickLinks from '@/components/lc/Full/vertical-header/QuickLinks.vue';
...
<template>
    ...
    <v-menu open-on-hover :close-on-content-click="false" class="lp_wrapper position-relative">
        <template v-slot:activator="{ props }">
            <v-btn class="hidden-sm-and-down nav-links custom-hover-primary font-weight-regular" variant="text" v-bind="props"
    ...
    <v-menu open-on-hover :close-on-content-click="false" class="lp_wrapper position-relative">
        ...
        <v-sheet max-width="100%" width="950" height="100%" elevation="10" rounded="md" class="pa-6 pb-0 mx-auto overflow-hidden">
            <div>
                <v-row>
                    <v-col cols="12" md="8" class="d-flex py-0">
    ...
    <v-btn
        variant="text"
        class="custom-hover-primary font-weight-regular nav-links"
        href=""
        target="_blank"
        >Documentation</v-btn
    >
    <v-btn variant="text" class="custom-hover-primary font-weight-regular nav-links" href="https://support.wrappixel.com/" target="_blank"
        >Support</v-btn
    >
