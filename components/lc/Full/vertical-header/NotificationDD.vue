...
<template>
    ...
    <!-- ---------------------------------------------- -->
        ...
        <v-menu open-on-hover open-on-click>
            ...
            <v-sheet rounded="md" width="360" elevation="10" class="sheet">
                ...
                <perfect-scrollbar style="height: 350px">
                    <v-list class="py-0 theme-list" lines="two">
                        <v-list-item
                            ...
                            :value="item"
                            color="primary"
                            class="py-3 px-6 custom-text-primary"
                        >
                ...
                <div class="py-4 px-6 text-center">
                    <v-btn color="primary" variant="outlined" size="large" block>See all Notifications</v-btn>
                </div>
            </v-sheet>
        </v-menu>
