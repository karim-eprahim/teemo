...
// import FullLogo from '../logo/FullLogo.vue';
...
<template>
    <v-app-bar elevation="0" :priority="priority" height="70" id="top" class="main-head bg-background">
        <div class="d-flex align-center gap-2">
            <v-btn
                class="hidden-md-and-down my-2 custom-hover-primary"
                icon
                size="small"
                variant="text"
                color="primary"
